...
export class ScenarioProps {
  ...
  // ---- BATHROOM WALL (fall event) ----
  _buildBathroomWall() {
    const wallGroup = new THREE.Group();
    // Light tile-like material for bathroom
    ...
    // Solid wall rotated 90 degrees, spanning X axis at Z = 0.5
    // Reduced length to 4 and shifted to X=2 to still cover the human model
    wallGroup.add(this._box(2, 1.5, 0.5, 4, 3, 0.2, wallMat));

    this._props.bathroomWall = wallGroup;
